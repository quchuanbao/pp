            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green sbold uppercase">权限管理</span>
                    </div>
                    <div class="actions">
                        <a class="btn btn-success" href="/admin/permission">
                ...
                <div class="portlet-body">
                    ...
                    <form  class="form-horizontal" role="form" method="POST" action="{{ url('/admin/permission/store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
